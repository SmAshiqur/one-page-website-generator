    ...
    <section className="relative h-[600px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl md:text-2xl font-semibold mb-8 max-w-3xl mx-auto">
            {currentSlideData.subtitle}
          </p>
          <button 
            className="bg-[#2A5BBE] cursor-pointer text-white px-12 py-4 rounded-sm font-semibold shadow-md hover:shadow-lg hover:bg-[#244ea6] transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 text-lg"
