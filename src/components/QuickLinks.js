...
export default function QuickLinks() {
  // Define icons and links for each quick link
  const quickLinksData = [
    {
      name: 'Registration',
      url: 'https://secure-api.net/school/registration/demo-mosque',
      isExternal: true,
      icon: (
  ...
  return (
    <section className="py-16 bg-[#fff]">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-4xl text-black font-bold text-center mb-8">Quick Links</h2>
