        ...
        <div className="text-center mt-8">
          ...
          <div className="space-x-4 mt-12">
            <button 
              ...
              className="border-2 border-[#2A5BBE] bg-[#2A5BBE] cursor-pointer text-white px-12 py-3 rounded-sm font-semibold shadow-md hover:shadow-lg hover:bg-[#244ea6] transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
            >
              REGISTER NOW
            </button>
          </div>
